...
function readLocalPackage() {
  try {
    ...
    return { name: json.name || "dhoner-fca", version: json.version || "1.0.0" };
  } catch (_) {
    return { name: "dhoner-fca", version: "1.0.0" };
  }
}
